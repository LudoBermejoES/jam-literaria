...
// Serve static files in production (only if nginx is not handling static files)
if (process.env.NODE_ENV === 'production' && process.env.SERVE_STATIC === 'true') {
  // In production, the client files are deployed to /var/www/jam-client
  // and the server is deployed to /var/www/jam-server
  const clientPath = process.env.CLIENT_PATH || path.join(__dirname, '../jam-client');
